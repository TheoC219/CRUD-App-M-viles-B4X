...
clasificacion.myClass = BA.getDeviceClass ("b4a.example.clasificacion");
productos.myClass = BA.getDeviceClass ("b4a.example.productos");
clasificaciones.myClass = BA.getDeviceClass ("b4a.example.clasificaciones");
b4xproductos.myClass = BA.getDeviceClass ("b4a.example.b4xproductos");
b4xclasificaciones.myClass = BA.getDeviceClass ("b4a.example.b4xclasificaciones");
